...
$con=mysqli_connect($servername,$username,$password,$dbname);
	...
	if($age>0 && $age<15)
	{		
	$sql="INSERT INTO child VALUES('$name','$age','$gender','$dob','$childcity','$hospitalname','$chkstr','$vaccinedate')";
...
<div class="box">
<label>name:</label>
<input type="text" name="t1" placeholder="Enter the Child name" autocomplete="off" required>
<label>age:</label>
