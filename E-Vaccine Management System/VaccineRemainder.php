...
if($result-> num_rows>0){
	while($row=$result-> fetch_assoc()){
		...
		echo"<tr><td>".$row["name"]."</td><td>".$row["age"]."</td><td>".$row["gender"]."</td><td>".$row["dob"]."</td><td>".$row["childcity"]."</td><td>".$row["hospitalname"]."</td><td>".$row["vaccine"]."</td><td>".$row["vaccinedate"]."</td><td>".$row["nextdate"]."</td></tr>";
